...
class ShortAnswerBuilderTest(unittest.TestCase):
    ...
    @patch('web.short_answer.get_short_answer_questions_by_exam', return_value=MOCK_QUESTION_LIST) 
    ...
    def test_short_answer_creation_success(self, render, exam_exists, mock_get_questions, mock_create_short_answer):
    ...
    @patch('web.short_answer.exam_exists', return_value=True)
    @patch('web.short_answer.render')
    def test_short_answer_creation_missing_question_text(self, render, exam_exists, mock_get_questions, mock_create_short_answer):
    ...
    @patch('web.short_answer.exam_exists', return_value=True)
    @patch('web.short_answer.render')
    def test_short_answer_creation_invalid_marks(self, render, exam_exists, mock_get_questions, mock_create_short_answer):
        """
        ...
        rendered_context = render.call_args[0][1]
        self.assertIn("Marks must be a positive integer.", rendered_context['errors_html'])
