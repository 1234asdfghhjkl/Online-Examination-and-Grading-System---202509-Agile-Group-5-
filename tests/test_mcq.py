...
class MCQBuilderTest(unittest.TestCase):
    ...
    def test_mcq_creation_success(
        self, render, exam_exists, mock_get_questions, mock_create_mcq
    ):
        ...
        response_html, status_code = post_mcq_builder(
            exam_id="test_exam_101", body=VALID_FORM_BODY
        )
    ...
    @patch("web.mcq.exam_exists", return_value=True)
    @patch("web.mcq.render")
    def test_mcq_creation_missing_field(
        self, render, exam_exists, mock_get_questions, mock_create_mcq
    ):
        ...
        response_html, status_code = post_mcq_builder(
            exam_id="test_exam_101", body=invalid_body
        )
    ...
    @patch("web.mcq.exam_exists", return_value=True)
    @patch("web.mcq.render")
    def test_mcq_creation_invalid_correct_option(
        self, render, exam_exists, mock_get_questions, mock_create_mcq
    ):
        """
