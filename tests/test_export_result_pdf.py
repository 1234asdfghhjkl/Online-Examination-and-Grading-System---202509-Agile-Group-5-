...
class PDFServiceTest(unittest.TestCase):
    ...
    def test_generate_result_pdf_calls_reportlab_correctly(
        ...
        MockParagraph.assert_any_call("Exam Result: Advanced Python Final", unittest.mock.ANY)
        
        # Check if the main Summary Table was created
        self.assertTrue(MockTable.called, "Table constructor should be called at least once.")
        ...
        MockParagraph.assert_any_call(MOCK_RESULT_DATA['mcq_results'][0]['question_text'], unittest.mock.ANY)
        ...
        MockParagraph.assert_any_call(MOCK_RESULT_DATA['sa_results'][0]['question_text'], unittest.mock.ANY)
        
        # Check for SA student answer text
        MockParagraph.assert_any_call(MOCK_RESULT_DATA['sa_results'][0]['student_answer'], unittest.mock.ANY)
        
        # 5. Assert Return Value
        self.assertIsInstance(pdf_bytes, bytes, "Function should return PDF content as bytes.")
