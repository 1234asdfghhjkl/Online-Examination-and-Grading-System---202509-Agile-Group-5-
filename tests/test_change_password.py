...
class ChangePasswordTest(unittest.TestCase):
    ...
    @patch("web.password_routes.render")
    def test_post_change_password_success(self, mock_render, mock_auth, mock_update_firebase):
        ...
        self.assertEqual(redirect_url, "/login") # Requirement says "Logout user on success"
