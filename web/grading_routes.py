...
def get_grading_dashboard(exam_id: str):
    ...
    for sub in submissions:
        ...
        # Status Badges
        mcq_status = '<span class="badge bg-success">Auto-Graded</span>' if sub.get("mcq_graded") else '<span class="badge bg-secondary">Pending</span>'
        ...
        if sub.get("sa_graded"):
             ...
             if is_locked:
                 action_btn = '<button class="btn btn-sm btn-secondary" disabled>Locked</button>'
             else:
